...
``` swift
 func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // firestore db 에 creditCardList 컬렉션이 없을시 생성하고 요소들을 추가한다.
        // 요소들은 이미 CreditCardDummy.swift 로 구현함
        db.collection("creditCardList").getDocuments{ snapshot, _ in
            ...
            do{
                ...
                print("ERROR wrinting card to Firestore \(error.localizedDescription)")
            }
            
            batch.commit() // 커밋해줘야 업데이트됌
        }
